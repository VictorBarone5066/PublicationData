...
extern double GENERAL_BOND_DISTANCE = 5.5; ///(angstroms) distance between any two atoms for them to be considered bonded (works well for POSCARS with only a few atom types)
